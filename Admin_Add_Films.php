...
<div style="width:100%; height:55px;" class="wrapperr">
  ...
  <form class="login" method="POST">
    <p class="title">Add Films</p>
    <input type="text" placeholder="Theatre Name" name="theatrename" autofocus/>
...
if(isset($_POST["submit"])){
    ...
    while($temp=mysqli_fetch_array($S)){
        if(($temp['Theatre']==$theatrename)&&($temp['Film']==$film)){
            $flag=TRUE;
        }
    }
    if(!$flag){
        $command="INSERT INTO films values(id,'$theatrename','$film')";
        ...
        echo "<script>alert('This film is already being played at this theatre')</script>";
    }
}
else{
