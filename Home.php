    ...
    <div style="display:flex; flex-direction:column;">
        <div style="margin-top:30px; width:100%;">
            ...
            <div style="margin-left:10%; width:60%; height:400px;float:left" class="wrapper">
                ...
                <h3>You can click on any of the links above to manage your website facilities</h3>
            </div>

        </div>
            <div class="wrapper" style="padding-bottom: 20px; margin-bottom:0px; margin-top:90px">
