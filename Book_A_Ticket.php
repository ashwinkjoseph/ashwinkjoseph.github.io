...
footer a, footer a:link {
  ...
  <form class="login" method="POST">
    <p class="title">Choose Theatre</p>
    ...
    <button name="submit">
      <i class="spinner"></i>
      <span class="state">Check Films</span>
    </button>
  </form>
  </p>
</div>
...
if(isset($_POST["submit"])){
    $_SESSION['Theatre_Name']=$_POST['dropdown'];
   // header("location:Book_A_Ticket2.php");
    echo "<script>window.location.href='Book_A_Ticket2.php';</script>";
}
?>
